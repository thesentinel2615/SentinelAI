...
const CHARACTER_FOLDER = 'data/character_info/';
const CHARACTER_IMAGES_FOLDER = 'data/character_images/';
const CHARACTER_ADVANCED_FOLDER = 'data/advanced_characters/';
const BACKGROUNDS_FOLDER = 'data/backgrounds/';
const USER_IMAGES_FOLDER = 'data/user_avatars/';
const AUDIO_OUTPUT = 'audio/';
const HORDE_API_URL = 'https://aihorde.net/api/';
const CONVERSATIONS_FOLDER = 'data/conversations/';
const CHARACTER_EXPORT_FOLDER = 'data/exports/';
